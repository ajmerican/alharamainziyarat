...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        // Redirect to a dedicated thank‑you page after a short delay. The delay
        // allows the mail client to open in a new tab without interrupting the
        // navigation. A custom thankyou.html page informs the user that
        // their registration was received and provides next steps.
        setTimeout(() => {
